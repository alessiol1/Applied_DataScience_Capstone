...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                                options=[{'label': site, 'value': site} for site in spacex_df['Launch Site'].unique()] + [{'label': 'All Sites', 'value': 'All Sites'}],
                                                value="All Sites",
                                                searchable=True
                                                ),
                                html.Br(),
...
def get_scatter_chart(selected_site, payload_range):
    ...
    if selected_site != "All Sites":
        # Further filter the DataFrame based on the selected site
    ...
    fig = px.scatter(
        ...
        title=f"Payload Mass vs. Launch Success for {selected_site if selected_site != 'All Sites' else 'All Sites'}"
    )
